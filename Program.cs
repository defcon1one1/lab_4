...
namespace lab_4
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            Dictionary<string, FileInfo> audios = new Dictionary<string, FileInfo>();
            Dictionary<string, FileInfo> videos = new Dictionary<string, FileInfo>();
            Dictionary<string, FileInfo> documents = new Dictionary<string, FileInfo>();
            Dictionary<string, FileInfo> others = new Dictionary<string, FileInfo>();

            foreach (var file in allFiles)
            {
                if (fileTypes["image"].Contains(file.Value.Extension))
                {
